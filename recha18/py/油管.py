...
CATEGORY_QUERY = {
    '動畫片': '動畫 國漫 anime cartoon',
    '漫劇': '漫劇 ai漫劇 ai動畫',
    '短劇': '短劇',
    '劇集': '電視劇 連續劇 劇集 drama',
    '電影': '電影 movie',
    '紀錄片': '紀錄片 documentary',
    '放松': '放松 冥想 自然 音樂 relax meditation nature',
    '新聞': '新聞',
    '新聞直播': '新聞直播',
    '自然': '大自然 風景 動物 世界 nature wildlife scenery',
    '16K HDR': '16K HDR video',
    '歌曲': '歌曲 美國歌曲 韓國歌曲 日文歌曲',
    '解說': '電影解說 故事解說',
}
...
CATEGORY_FILTERS = {
    '動畫片': _with_year(
        _filter_group('topic', '中文', [
            ('國漫', '國漫 3D 動畫'), ('兒童早教', '兒童早教'), ('兒童歌曲', '兒童歌曲'),
            ('兒童音樂', '兒童音樂'), ('兒童繪畫', '兒童繪畫'), ('寶寶巴士', '寶寶巴士'),
            ('兒歌多多', '兒歌多多'), ('英語啟蒙', '兒童英語啟蒙'), ('安全教育', '兒童安全教育'),
        ]),
        _filter_group('channel', '頻道', [
            ('小豬佩奇', '@PeppaPigChineseOfficial 小豬佩奇 中文'), ('CoComelon', '@CoComelon'),
            ('國漫合集', 'Anime ENG SUB 合集 國漫'), ('閱文動漫', '@yuewenanimation'),
            ('嗶哩動漫', '@madebybilibili 嗶哩動漫'), ('騰訊動漫', '@TencentVideoAnimation'),
            ('優酷動漫', '@youkuanimation 優酷動漫'), ('愛奇藝動漫', '@iQIYIAnime 愛奇藝動漫'),
        ])
    ),
    '短劇': _with_year(
        _filter_group('region', '地區/平台', [
            ('抖音', '抖音 短劇'), ('快手', '快手 短劇'), ('大陸', '大陸 短劇'),
            ('香港', '香港 短劇'), ('澳門', '澳門 短劇'), ('台灣', '台灣 短劇'),
            ('新加坡', '新加坡 短劇'), ('馬來西亞', '馬來西亞 短劇'), ('泰國', '泰國 短劇'),
            ('越南', '越南 短劇'), ('印度', '印度 短劇'), ('韓國', '韓國 短劇'),
            ('日本', '日本 短劇'), ('歐美', '歐美 短劇'), ('騰訊', '騰訊 短劇'),
            ('愛奇藝', '愛奇藝 短劇'), ('優酷', '優酷 短劇'), ('芒果', '芒果TV 短劇'), ('搜狐', '搜狐 短劇'),
        ]),
        _filter_group('topic', '題材/頻道', [
            ('都市', '@Urbanshort-TV 都市 短劇'), ('愛情', '愛情 短劇'), ('復仇', '復仇 短劇'),
            ('穿越', '穿越 短劇'), ('喜劇', '喜劇 短劇'), ('奇幻', '奇幻 短劇'),
            ('九醬愛追劇', '@NineSauceDramaTV'), ('百萬好劇場', '@1-pw5ox'),
            ('咖啡追劇', '@coffeedrama605'), ('斗羅短劇', '@DouluoDrama123 斗羅短劇'),
            ('嘟嘟劇場', '@DUDUJUCHANG'), ('牛牛短劇', '@niuniuduanju'),
        ])
    ),
    '劇集': _with_year(
        _filter_group('region', '中文', [
            ('華語熱播', '華語熱播電視劇官方頻道'), ('粵劇', '粵劇 劇集'), ('TVB', '@TVB'),
            ('國劇放映社', '國劇放映社'), ('大陸', '大陸 劇集'), ('騰訊', '騰訊 劇集'),
            ('愛奇藝', '愛奇藝 劇集'), ('優酷', '優酷 劇集'), ('芒果', '芒果TV 劇集'),
            ('搜狐', '搜狐 劇集'), ('港台', '港台 劇集'), ('美國', '美國 劇集'),
            ('韓國', '韓國 劇集'), ('日本', '日本 劇集'), ('英國', '英國 劇集'),
        ]),
    ...
    '電影': _with_year(
        _filter_group('region', '地區/平台', [
            ('大陸', '大陸 電影'), ('騰訊', '騰訊 電影'), ('愛奇藝', '愛奇藝 電影'),
            ('優酷', '優酷 電影'), ('芒果', '芒果TV 電影'), ('搜狐', '搜狐 電影'),
            ('港台', '港台 電影'), ('美國', '美國 movie'), ('韓國', '韓國 電影'),
            ('日本', '日本 電影'), ('英國', '英國 movie'),
        ]),
        _filter_group('platform', '平台', [
    ...
    '紀錄片': _with_year(
        _filter_group('topic', '主題', [
            ('歷史', '歷史 紀錄片'), ('野性', '野性 紀錄片 wild documentary'),
            ('地球', '地球 紀錄片 earth documentary'), ('宇宙', '宇宙 紀錄片 universe documentary'),
            ('海洋', '海洋 紀錄片 oceans documentary'), ('人文', '人文 紀錄片'),
            ('戰爭', '戰爭 紀錄片 war documentary'), ('BBC', 'BBC 紀錄片 documentary'),
            ('國家地理', '國家地理 National Geographic documentary'), ('Netflix', 'netflix 紀錄片 documentary'),
        ])
    ),
    '放松': [
        _filter_group('topic', '主題', [
            ('冥想', '冥想 放松 meditation relax'), ('睡眠', '睡眠 放松 sleep relax'),
            ('白噪音', '白噪音 放松 white noise'), ('自然聲音', '自然 聲音 放松 nature sounds'),
            ('雨聲', '雨聲 放松 rain sounds'), ('海浪', '海浪 放松 ocean waves'),
        ])
    ],
    '4K': [
        _filter_group('topic', '主題', [
            ('風景', '4K 風景 scenery'), ('城市', '4K 城市 city walk'), ('旅行', '4K travel'),
            ('動物', '4K wildlife animals'), ('航拍', '4K drone aerial'), ('演示片', '4K demo video'),
        ])
    ],
    'HDR': [
        _filter_group('topic', '主題', [
            ('風景', 'HDR 風景 scenery'), ('自然', 'HDR nature'), ('動物', 'HDR wildlife animals'),
            ('城市', 'HDR city'), ('演示片', 'HDR demo video'), ('放松', 'HDR relax'),
        ])
    ],
    '自然': [
        _filter_group('topic', '主題', [
            ('風景', '大自然 風景 nature scenery'), ('動物世界', '動物世界 wildlife documentary'),
            ('海洋', '海洋 自然 ocean nature'), ('森林', '森林 自然 forest nature'),
            ('鳥類', '鳥類 自然 birds nature'), ('地球', '地球 自然 earth nature'),
            ('國家地理', 'National Geographic nature wildlife'), ('BBC Earth', 'BBC Earth nature'),
        ])
    ],
    '16K HDR': [
        _filter_group('topic', '風景', [
            ('運動', 'GoPro 極限自行車 翼裝飛行'), ('風景', 'hdr 大自然 風景'),
            ('Links TV', '@linksphotograph Links TV hdr'), ('放松', 'hdr 放松'),
            ('動物世界', 'hdr Carnivorous Animals 動物世界'), ('深海世界', 'hdr Invertebrate Fish 深海世界'),
            ('飛禽走獸', 'hdr Birds of Prey Birds'), ('生物世界', 'hdr Amphibians Reptiles 生物世界'),
        ])
    ],
    '科技': [
        _filter_group('topic', '主題', [
            ('AI', '人工智能 AI technology'), ('數碼', '數碼 科技 technology'),
            ('手機', '手機 評測 technology'), ('電腦', '電腦 科技 technology'),
            ('汽車科技', '汽車 科技 technology'), ('太空', '航天 太空 technology'),
        ])
    ],
    '解說': [
        _filter_group('channel', '頻道主', [('宇哥侃故事', '@yuge'), ('零度解說', '@lingdujieshuo')])
    ],
}
